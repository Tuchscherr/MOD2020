...
*/
	...
	int ElegirEnemigo ()
	{
		Debug.Log ("Enemigo:" + enemigoActual + " Dragoncito1: " + dragoncitoE1 + " Dragoncito2: " + dragoncitoE2);
		int cantenemigos = 1;
		if (dragoncitoE1 > -1) {
			cantenemigos++;
		}
	...
	int ElegirAliado ()
	{
		Debug.Log ("Aliado: 0  Dragoncito1: " + Controlador.dragoncito1 + " Dragoncito2: " + Controlador.dragoncito2);
		int cantaliados = 1;
		if (Controlador.dragoncito1 > -1) {
			cantaliados++;
		}
